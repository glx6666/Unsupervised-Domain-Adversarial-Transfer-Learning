...
class MCD_F(nn.Module):
    """ResNet18 for 1D Signal"""

    def __init__(self):
        super(MCD_F, self).__init__()
...
class MCD_C1(nn.Module):
    def __init__(self, num_class):
        super(MCD_C1, self).__init__()
        self.fc1 = nn.Linear(256, 128)
...
class MCD_C2(nn.Module):
    def __init__(self, num_class):
        super(MCD_C2, self).__init__()
        self.fc1 = nn.Linear(256, 128)
        self.fc2 = nn.Linear(128, num_class)
        self.relu = nn.ReLU()
