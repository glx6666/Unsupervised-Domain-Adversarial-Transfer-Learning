...
class CWRU_knn(object):
    def __init__(self, source_dir, target_dir, no_label_target_dir, test_dir, transform=None, image=False):
        """
        ...
        self.no_label_target_dir = no_label_target_dir
        ...
        self.no_label_target_dir = self.load_cwru_data(self.no_label_target_dir)
    ...
    def train_test_split_order(self):
        ...
        no_label_target_train = self.no_label_target_dir
        ...
        if self.image:
            ...
            no_label_target_dataset = CustomCWRUDataset(no_label_target_train, transform=self.transform)
            test_dataset = CustomCWRUDataset(test_set, transform=self.transform)

        return source_dataset, target_dataset, no_label_target_dataset, test_dataset